                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" name="carCategory" class="form-control rounded" placeholder="Audi A3/Audi A5/Audi A7" value="{{$category->category_name}}" required> 
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group ">
                                        <label>Марка на која припаѓа моделот:</label>
                                        <select required class="form-control" name="car_id">
                                            @foreach ($cars as $car)
                                                @if($category->car_id == $car->id)
                                                    <option selected value="{{$car->id}}">{{$car->model_name}}</option>
                                                @endif
                                                @if($category->car_id != $car->id)
