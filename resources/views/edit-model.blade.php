            ...
            <div class="col-lg-10 col-md-12 ">
                <div class="card shadow-lg card-1">
                    <div class="card-body inner-card">
                        <form action={{url('/edit-model/'. $car->id)}} method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-12 col-lg-12 col-auto ml-2"><input type="submit" class="btn btn-primary rounded" value="Потврди измена" required></div>
                                <br>
                                <div class="col-md-12 col-lg-12 col-auto ml-2">
                                <h6> * Поради безбедносни причини, доколку правиме измена - сликата ќе мора да се одбере од почеток.</h6>
                                </div>
                            </div>
                        </form> 
                    </div>
